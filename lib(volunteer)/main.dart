...
// import 'screens/VolunteerRequestPage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: VolunteerHomePage(title : "Volunteer Page"),
    );
  }
}
    ...
    switch (index) {
      case 0: // Home
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const VolunteerHomePage(title: 'Home')),
        );
        break;
      case 1: // Explore
        Navigator.push(
      ...
      case 3: // Profile
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>  VolunteerAccPage(title:'Volunteer Dashboard')), // Replace with your ProfilePage widget
        );
        break;
    }
  }
